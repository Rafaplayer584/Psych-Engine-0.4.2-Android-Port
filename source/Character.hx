...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false, ?fromCache:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'dad':
				noteSkin = 'dad';
				tex = Paths.getSparrowAtlas('characters/extra/DADDY_DEAREST');
				frames = tex;
				animation.addByIndices('idle', 'Dad idle dance instance 1', [0], "", 24, false);
			...
			case 'rafapray':
				iconColor = "FFd73c92";
				noteSkin = 'rafaplayer';
				frames = Paths.getSparrowAtlas('characters/extra/Rafaplayer_Assets', 'shared');
				animation.addByPrefix('idle', 'RP idle dance', 24, false);
				animation.addByPrefix('singUP', 'RP Sing Note UP', 24, false);
				animation.addByPrefix('singDOWN', 'RP Sing Note DOWN', 24, false);
				animation.addByPrefix('singLEFT', 'RP Sing Note LEFT', 24, false);
				animation.addByPrefix('singRIGHT', 'RP Sing Note RIGHT', 24, false);
				animation.addByPrefix('drop', 'RP drop', 24, false);
         animation.addByPrefix('drop', 'RP ending drop', 24, false);
			...
			case 'rafapray-ex':
				iconColor = "FF9E2947";
				noteSkin = 'rafaplayer';
				frames = Paths.getSparrowAtlas('characters/extra/rafapray-ex', 'shared');
				animation.addByPrefix('idle', 'RP idle dance', 24, false);
				animation.addByPrefix('singUP', 'RP Sing Note UP', 24, false);
				animation.addByPrefix('singDOWN', 'RP Sing Note DOWN', 24, false);
				animation.addByPrefix('singLEFT', 'RP Sing Note LEFT', 24, false);
...
playAnim('idle');
			case 'dark':
				iconColor = "FF9E2947";
				noteSkin = 'bruh';
					tex = Paths.getSparrowAtlas('characters/extra/Cool_Youtuber_Dark_Yahoo', 'shared');
					frames = tex;
					animation.addByPrefix('idle', "Dark idle", 24);
...
playAnim('idle');
			case 'spectraldark-ex':
				iconColor = "FF9E2947";
				noteSkin = 'bruh';
					tex = Paths.getSparrowAtlas('characters/extra/Cool_Dark_EX_Outfit', 'shared');
					frames = tex;
					animation.addByPrefix('idle', "Dark idle", 24);
					animation.addByPrefix('singUP', 'Dark up', 24, false);
					animation.addByPrefix('singDOWN', 'Dark down', 24, false);
         ...
         playAnim('idle');
			case 'littlerp':
				iconColor = "FF9E2947";
				noteSkin = 'littlewhat';
					tex = Paths.getSparrowAtlas('characters/extra/Tiny_Too_Tiny_Guy', 'shared');
					frames = tex;
					animation.addByPrefix('idle', "idle", 24);
					animation.addByPrefix('singUP', 'up', 24, false);
					animation.addByPrefix('singDOWN', 'down', 24, false);
			...
			switch (curCharacter)
			{
				...
				case 'ash' | 'ash-ex' | 'ash2':
					...
					if (danced)
						...
						playAnim('danceLeft');
				case 'rafapray' | 'bluskys' | 'rafapray-ex':
